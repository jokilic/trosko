...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1516: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      _1526: (x0,x1) => x0.end(x1),
      _1527: x0 => x0.pause(),
      _1528: x0 => x0.play(),
      _1529: x0 => x0.load(),
      _1530: (x0,x1) => x0.removeAttribute(x1),
      _1531: (x0,x1) => x0.setSinkId(x1),
      _1539: x0 => x0.delete(),
      _1545: (x0,x1) => globalThis.firebase_auth.reauthenticateWithCredential(x0,x1),
      _1559: x0 => x0.toJSON(),
      ...
      _1562: (x0,x1,x2) => x0.onAuthStateChanged(x1,x2),
      ...
      _1567: (x0,x1,x2) => x0.onIdTokenChanged(x1,x2),
      _1571: (x0,x1,x2) => globalThis.firebase_auth.createUserWithEmailAndPassword(x0,x1,x2),
      _1581: (x0,x1,x2) => globalThis.firebase_auth.signInWithEmailAndPassword(x0,x1,x2),
      _1586: x0 => x0.signOut(),
      _1587: (x0,x1) => globalThis.firebase_auth.connectAuthEmulator(x0,x1),
      _1592: (x0,x1) => globalThis.firebase_auth.EmailAuthProvider.credential(x0,x1),
      _1610: x0 => globalThis.firebase_auth.OAuthProvider.credentialFromResult(x0),
      _1625: x0 => globalThis.firebase_auth.getAdditionalUserInfo(x0),
      _1626: (x0,x1,x2) => ({errorMap: x0,persistence: x1,popupRedirectResolver: x2}),
      _1627: (x0,x1) => globalThis.firebase_auth.initializeAuth(x0,x1),
      _1633: x0 => globalThis.firebase_auth.OAuthProvider.credentialFromError(x0),
      _1648: () => globalThis.firebase_auth.debugErrorMap,
      _1651: () => globalThis.firebase_auth.browserSessionPersistence,
      _1653: () => globalThis.firebase_auth.browserLocalPersistence,
      _1655: () => globalThis.firebase_auth.indexedDBLocalPersistence,
      _1658: x0 => globalThis.firebase_auth.multiFactor(x0),
      _1659: (x0,x1) => globalThis.firebase_auth.getMultiFactorResolver(x0,x1),
      _1661: x0 => x0.currentUser,
      _1665: x0 => x0.tenantId,
      _1675: x0 => x0.displayName,
      _1676: x0 => x0.email,
      _1677: x0 => x0.phoneNumber,
      _1678: x0 => x0.photoURL,
      _1679: x0 => x0.providerId,
      _1680: x0 => x0.uid,
      _1681: x0 => x0.emailVerified,
      _1682: x0 => x0.isAnonymous,
      _1683: x0 => x0.providerData,
      _1684: x0 => x0.refreshToken,
      _1685: x0 => x0.tenantId,
      _1686: x0 => x0.metadata,
      _1688: x0 => x0.providerId,
      _1689: x0 => x0.signInMethod,
      _1690: x0 => x0.accessToken,
      _1691: x0 => x0.idToken,
      _1692: x0 => x0.secret,
      _1703: x0 => x0.creationTime,
      _1704: x0 => x0.lastSignInTime,
      _1709: x0 => x0.code,
      _1711: x0 => x0.message,
      _1723: x0 => x0.email,
      _1724: x0 => x0.phoneNumber,
      _1725: x0 => x0.tenantId,
      _1748: x0 => x0.user,
      _1751: x0 => x0.providerId,
      _1752: x0 => x0.profile,
      _1753: x0 => x0.username,
      _1754: x0 => x0.isNewUser,
      _1757: () => globalThis.firebase_auth.browserPopupRedirectResolver,
      _1762: x0 => x0.displayName,
      _1763: x0 => x0.enrollmentTime,
      _1764: x0 => x0.factorId,
      _1765: x0 => x0.uid,
      _1767: x0 => x0.hints,
      _1768: x0 => x0.session,
      _1770: x0 => x0.phoneNumber,
      _1782: (x0,x1) => x0.getItem(x1),
      _1788: (x0,x1) => x0.appendChild(x1),
      _1791: (x0,x1,x2) => x0.setItem(x1,x2),
      _1793: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1794: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1795: x0 => globalThis.firebase_core.getApp(x0),
      _1796: () => globalThis.firebase_core.getApp(),
      _1797: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      ...
      _1831: () => globalThis.removeSplashFromWeb(),
      _1833: Date.now,
      _1835: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1836: s => {
      ...
      _1838: () => typeof dartUseDateNowForTicks !== "undefined",
      _1839: () => 1000 * performance.now(),
      _1840: () => Date.now(),
      _1841: () => {
      ...
      _1843: () => new WeakMap(),
      _1844: (map, o) => map.get(o),
      _1845: (map, o, v) => map.set(o, v),
      _1846: x0 => new WeakRef(x0),
      _1847: x0 => x0.deref(),
      _1854: () => globalThis.WeakRef,
      _1857: s => JSON.stringify(s),
      _1858: s => printToConsole(s),
      _1859: (o, p, r) => o.replaceAll(p, () => r),
      _1860: (o, p, r) => o.replace(p, () => r),
      _1861: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1862: s => s.toUpperCase(),
      _1863: s => s.trim(),
      _1864: s => s.trimLeft(),
      _1865: s => s.trimRight(),
      _1866: (string, times) => string.repeat(times),
      _1867: Function.prototype.call.bind(String.prototype.indexOf),
      _1868: (s, p, i) => s.lastIndexOf(p, i),
      _1869: (string, token) => string.split(token),
      _1870: Object.is,
      ...
      _1892: o => o instanceof Int8Array,
      ...
      _1952: (handle) => clearTimeout(handle),
      _1953: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1954: (handle) => clearInterval(handle),
      _1955: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1956: () => Date.now(),
      _1961: o => Object.keys(o),
      _1962: (x0,x1,x2) => x0.transaction(x1,x2),
      _1963: (x0,x1) => x0.objectStore(x1),
      _1964: (x0,x1) => x0.getAllKeys(x1),
      _1965: (x0,x1) => x0.getAll(x1),
      _1967: (x0,x1) => x0.delete(x1),
      _1968: (x0,x1,x2) => x0.put(x1,x2),
      _1969: x0 => x0.clear(),
      _1970: x0 => x0.close(),
      _1972: (x0,x1,x2) => x0.open(x1,x2),
      _1973: (x0,x1) => x0.contains(x1),
      _1976: (x0,x1) => x0.createObjectStore(x1),
      ...
      _1987: () => new AbortController(),
      _1988: x0 => x0.abort(),
      _1989: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1990: (x0,x1) => globalThis.fetch(x0,x1),
      _1991: (x0,x1) => x0.get(x1),
      _1992: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1992(f,arguments.length,x0,x1,x2) }),
      _1993: (x0,x1) => x0.forEach(x1),
      _1994: x0 => x0.getReader(),
      _1995: x0 => x0.read(),
      _1996: x0 => x0.cancel(),
      ...
      _1999: x0 => x0.openCursor(),
      _2000: x0 => x0.continue(),
      ...
      _2020: (x0,x1) => x0.key(x1),
      _2021: x0 => x0.trustedTypes,
      _2022: (x0,x1) => { x0.text = x1 },
      _2032: (s, m) => {
        try {
      ...
      _2062: o => String(o),
      _2063: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _2064: o => {
      ...
      _2875: x0 => x0.error,
      _2876: x0 => x0.src,
      _2877: (x0,x1) => { x0.src = x1 },
      _2885: (x0,x1) => { x0.preload = x1 },
      _2886: x0 => x0.buffered,
      _2889: x0 => x0.currentTime,
      _2890: (x0,x1) => { x0.currentTime = x1 },
      _2891: x0 => x0.duration,
      _2896: (x0,x1) => { x0.playbackRate = x1 },
      _2909: (x0,x1) => { x0.volume = x1 },
      _2926: x0 => x0.code,
      _2927: x0 => x0.message,
      _3001: x0 => x0.length,
      _3507: (x0,x1) => { x0.type = x1 },
      _3515: (x0,x1) => { x0.crossOrigin = x1 },
      _3517: (x0,x1) => { x0.text = x1 },
      _3974: () => globalThis.window,
      _4014: x0 => x0.self,
      _4015: x0 => x0.document,
      _4018: x0 => x0.location,
      _4294: x0 => x0.indexedDB,
      _4299: x0 => x0.trustedTypes,
      _4300: x0 => x0.sessionStorage,
      _4301: x0 => x0.localStorage,
      _4316: x0 => x0.hostname,
      _4634: x0 => x0.length,
      _6539: x0 => x0.target,
      _6579: x0 => x0.signal,
      _6636: x0 => x0.baseURI,
      _6653: () => globalThis.document,
      _6736: x0 => x0.head,
      _8416: x0 => x0.value,
      _8418: x0 => x0.done,
      _9120: x0 => x0.url,
