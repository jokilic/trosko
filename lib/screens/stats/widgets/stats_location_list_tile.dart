...
class StatsLocationListTile extends StatefulWidget {
  ...
  @override
  State<StatsLocationListTile> createState() => _StatsLocationListTileState();
}

class _StatsLocationListTileState extends State<StatsLocationListTile> {
  var expanded = false;
